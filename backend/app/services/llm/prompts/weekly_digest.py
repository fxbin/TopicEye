...
{{
  ...
  "top_picks": [
    {{"rank": 1, "source_idx": 1, "source_title": "上方数据的原文标题（逐字复制，勿改写）", "title": "观点化选题标题（可改写为更吸引创作者的标题）", "source": "来源名称", "category": "分类", "reason": "中文摘要式推荐理由（60字内，概括核心信息+为什么值得写）", "score": 85, "platforms": ["公众号", "小红书"]}}
  ],
  "category_summary": {{
